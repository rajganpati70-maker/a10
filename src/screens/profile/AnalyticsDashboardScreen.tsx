// ============================================================================
// CreatorX Ultra Pro - AnalyticsDashboard Screen
...
// ============================================================================
// AnalyticsDashboard Screen Component
// ============================================================================
...
const AnalyticsDashboardScreen: React.FC = () => {
  ...
  const handleItemPress = useCallback(
    (item: any) => {
      haptic.light();
      navigation.navigate('ContentAnalytics' as never, { id: item.id } as never);
    },
    [haptic, navigation]
  );
      ...
      <Animated.View entering={FadeInDown.delay(300).springify()} style={styles.featuredSection}>
        <View style={styles.sectionHeader}>
          ...
          <AnimatedTouchable
            onPress={() => {
              haptic.light();
              navigation.navigate('ContentAnalytics' as never);
            }}
            hapticType="light"
          >
