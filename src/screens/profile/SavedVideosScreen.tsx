// ============================================================================
// CreatorX Ultra Pro - SavedVideos Screen
// Your saved videos collection
// Tab: Profile | Level: 2
// ============================================================================
...
const SavedVideosScreen: React.FC = () => {
  ...
  const handleItemPress = useCallback(
    (item: any) => {
      haptic.light();
      navigation.navigate('VideoPlayer' as never, { id: item.id } as never);
    },
    [haptic, navigation]
  );
