// ============================================================================
// CreatorX Ultra Pro - ChatScreen Screen
// Direct message chat
// Tab: Inbox | Level: 4
// ============================================================================
...
const ChatScreenScreen: React.FC = () => {
  ...
  const handleItemPress = useCallback(
    (item: any) => {
      haptic.light();
      navigation.navigate('UserProfileInbox' as never, { id: item.id } as never);
    },
    [haptic, navigation]
  );
      ...
      <Animated.View entering={FadeInDown.delay(300).springify()} style={styles.featuredSection}>
        <View style={styles.sectionHeader}>
          ...
          <AnimatedTouchable
            onPress={() => {
              haptic.light();
              navigation.navigate('UserProfileInbox' as never);
            }}
            hapticType="light"
          >
...
export default ChatScreenScreen;
