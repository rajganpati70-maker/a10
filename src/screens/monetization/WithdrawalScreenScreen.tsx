// ============================================================================
// CreatorX Ultra Pro - WithdrawalScreen Screen
// Bank/UPI withdrawal details
...
// ============================================================================
// WithdrawalScreen Screen Component
// ============================================================================

const WithdrawalScreenScreen: React.FC = () => {
  ...
  const handleItemPress = useCallback(
    (item: any) => {
      haptic.light();
      navigation.navigate('PaymentHistory' as never, { id: item.id } as never);
    },
    [haptic, navigation]
  );
...
export default WithdrawalScreenScreen;
